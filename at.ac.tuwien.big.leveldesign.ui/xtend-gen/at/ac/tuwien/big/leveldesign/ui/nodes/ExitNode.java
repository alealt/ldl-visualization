...
public class ExitNode extends BaseNode<Exit> {
  public ExitNode(final IMappedElementDescriptor<Exit> descriptor) {
    super(descriptor);
    final Function1<Exit, Coordinate> _function = (Exit it) -> {
